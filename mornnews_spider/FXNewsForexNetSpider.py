...
def crawMorningForexDailyNews(linkUrl):
    ...
    for mainContext in contextList:
        ...
        currentArray.append([str(uuid.uuid1()),linkUrl,imageUrl,title,pubDate,descriptContext,'FOREX','FXNET'])
    return currentArray
...
def writeMorningForexDailyNews():
    ...
    SQL = "DELETE  FROM  MORNING_OTHERNEWS_RESOURCE_TABLE  WHERE  SOURCEFLAG = 'FXNET' AND  NEWSFLAG='FOREX'"
